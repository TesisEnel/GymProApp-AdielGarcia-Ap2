                ...
                uiState.productos.forEach { producto ->
                    item {
                        GymProContentCard(
                            ...
                            Row {
                                val image = when (producto.categoria) {
                                    Categorias.ROPA -> R.drawable.ropa_de_deporte
                                    Categorias.ACCESORIOS -> R.drawable.accessory
                                    else -> R.drawable.comida_suplementaria
                                }
                                Image(
